...
Pod::Spec.new do |s|
  ...
  s.name = "Core"
  s.version = "1.0.0"
  s.summary = "Test Core.framework for modularization"
  ...
  s.author = { "Ricky Primayuda Putra" => "rickyprima30@gmail.com" }
  # Or just: spec.author    = "Ricky Primayuda Putra"
  # spec.authors            = { "Ricky Primayuda Putra" => "113336156+rickyprimay@users.noreply.github.com" }
  # spec.social_media_url   = "https://twitter.com/Ricky Primayuda Putra"
